...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i436.LoginRepoImpl>(
        () => _i436.LoginRepoImpl(gh<_i976.RemoteApiDataSoucrceImpl>()));
    gh.factory<_i813.Loginusecase>(
        () => _i813.Loginusecase(gh<_i436.LoginRepoImpl>()));
    gh.factory<_i39.LoginCubit>(
        () => _i39.LoginCubit(gh<_i813.Loginusecase>()));
    gh.factory<_i976.RemoteApiDataSoucrceImpl>(
        () => _i976.RemoteApiDataSoucrceImpl(gh<_i266.ApiManager>()));
    return this;
  }
}
